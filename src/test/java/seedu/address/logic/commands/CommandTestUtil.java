...
public class CommandTestUtil {
    ...
    public static final String VALID_ROLE_BOB = "UI Designer";
    ...
    public static final String INVALID_ROLE_DESC = " " + PREFIX_ROLE; // empty string not allowed for rolees
     ...
     * - the role book, filtered person list and selected person in {@code actualModel} remain unchanged
     */
